...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: Bikash & Aditya  (@BikashHalder)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
@Client.on_message(
    commandpro(["play", "/play", "!play", ".play", "bgt", "@", "#"])
    & filters.group
    & ~filters.edited
    & ~filters.forwarded
    & ~filters.via_bot
...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**🎸 𝐏𝐥𝐞𝐚𝐬𝐞 ❤️ 𝐌𝐚𝐧𝐮𝐚𝐥𝐥𝐲 🥀 𝐀𝐝𝐝 💫 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 😔 𝐎𝐫 🎸 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 ❤️ 𝐓𝐨 ː [𓆩❛-𝐌𝐫᭄'𝐁𝐠𝐓-𝐎𝐰𝐧𝐞𝐑°𓆪](https://t.me/BgtPromote) ✨ ...**")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://graph.org/file/d4bc06ada79821eb01025.jpg"
...
@Client.on_message(commandpro(["reload", ".reload", "!reload", "/reload", "rld"]))
@errors
@authorized_users_only
